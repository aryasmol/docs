...
<Note>
  **Prerequisite:** You must first create an agent on the [Atoms platform](https://atoms.smallest.ai). This command will prompt you to select from your existing agents.
</Note>
